...
Scene* Lvl3Scene::createScene()
{
    // adding physics world
    auto scene = Scene::createWithPhysics();
    auto layer = Lvl3Scene::create();
    scene->addChild(layer);
    return scene;
    return Lvl3Scene::create();
}
...
bool Lvl3Scene::init()
{
    ...
    wall->setPosition(Vec2(visibleSize.width / 2 + origin.x - 20,visibleSize.height / 2 + origin.y + 50));
    addChild(wall);
...
void Lvl3Scene ::GoToPauseScene(cocos2d::Ref* pSender)
{
